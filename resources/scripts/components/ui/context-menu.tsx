...
function ContextMenu({ ...props }: ContextMenuBase.Root.Props) {
...
function ContextMenuTrigger({
  ...
  children,
  ...props
}: ContextMenuBase.Trigger.Props & { asChild?: boolean }) {
  if (asChild) {
    const child = React.Children.only(children) as React.ReactElement
    return (
      <ContextMenuBase.Trigger data-slot="context-menu-trigger" render={child} {...props} />
    )
  }
  return (
    <ContextMenuBase.Trigger data-slot="context-menu-trigger" className={className} {...props}>
      {children}
    </ContextMenuBase.Trigger>
  )
}

function ContextMenuPortal({ ...props }: ContextMenuBase.Portal.Props) {
...
function ContextMenuContent({
  className,
  ...props
}: ContextMenuBase.Popup.Props &
  Pick<
    ContextMenuBase.Positioner.Props,
    "align" | "alignOffset" | "side" | "sideOffset"
  >) {
  return (
    <ContextMenuBase.Portal>
      <ContextMenuBase.Positioner className="isolate z-50 outline-none">
...
function ContextMenuGroup({ ...props }: ContextMenuBase.Group.Props) {
...
function ContextMenuLabel({
  ...
  inset,
  ...props
}: ContextMenuBase.GroupLabel.Props & {
  inset?: boolean
}) {
  return (
...
function ContextMenuRadioGroup({ ...props }: ContextMenuBase.RadioGroup.Props) {
  return (
...
function ContextMenuSub({
  ...
  return <ContextMenuBase.SubmenuRoot data-slot="context-menu-sub" {...props} />
}
...
function ContextMenuSeparator({
  className,
  ...props
}: ContextMenuBase.Separator.Props) {
  return (
