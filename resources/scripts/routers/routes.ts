...
import LanguageSettingsContainer from '@/components/account/LanguageSettingsContainer';
...
const routes: Routes = {
    account: [
        ...
        },
        {
            route: 'api',
            path: 'api',
            name: i18n.t('common:api_credentials'),
            component: AccountApiContainer,
        },
        {
            route: 'ssh',
            path: 'ssh',
            name: i18n.t('common:ssh_keys'),
            component: AccountSSHContainer,
        },
        {
            route: 'language',
            path: 'language',
            name: i18n.t('account:sidebar_language'),
            component: LanguageSettingsContainer,
        },
        {
            route: 'activity',
            path: 'activity',
            name: i18n.t('common:activity'),
